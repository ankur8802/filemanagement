...
<html lang="en">
   <head>
      <meta charset="utf-8" />
      <title>MGU-FERP | LATEST FILES </title>
                  ...
                  <div class="card mb-3">
                     <div class="card-body">
                        <div class="d-flex fw-bold small mb-3">
                           <span class="flex-grow-1 text-white text-uppercase"> LATEST FILES  <small class="text-info">(Click on File name For Download)</small> </span>
                        </div>
                              ...
                              <table id="datatableDefault" class="table table-bordered text-center">
                                ...
                                <tbody>
                                  <?php
                                     ...
                                     {
                                         $checkurgent = $latestfiles->filemark;
                                         $checkurgentarray=explode(",",$checkurgent);
                                  ?>
                                    <tr>
                                        <td>
                                            <a href="<?= base_url()?>uploads/mgufiles/<?= $latestfiles->docfile?>" download> <?= $latestfiles->fname?>
                                            <?php
