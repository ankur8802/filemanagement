                  ...
                  <div class="card mb-3">
                     <div class="card-body">
                        <div class="d-flex fw-bold small mb-3">
                           <span class="flex-grow-1 text-white text-uppercase"> PUBLIC FILES  <small class="text-info">(Click on File name For Download)</small> </span>
                        </div>
                              ...
                              <table id="datatableDefault" class="table table-bordered text-center">
                                ...
                                <tbody>
                                  <?php
                                     ...
                                     {
                                         $checkurgent = $publicfiles->filemark;
                                         $checkurgentarray=explode(",",$checkurgent);
                                  ?>
                                    <tr> 
                                        <td>
                                            <a href="<?= base_url()?>uploads/mgufiles/<?= $publicfiles->docfile?>" download> <?= $publicfiles->fname?>
                                            <?php
