...
<?php
  ...
  {
?>
                            <a href="<?= base_url('reactive-group-by-super-admin')?>/<?= $findgroup->id;?>" class="btn btn-outline-success"> Re-Active Group </a>

                            <a href="<?= base_url('permanent-delete-group-by-super-admin')?>/<?= $findgroup->id;?>" class="btn btn-outline-danger mt-1 w-100"> Delete Permanent </a>
<?php }?>
                        </div>
